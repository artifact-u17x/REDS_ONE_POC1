...
if "%RESPONSE_CODE%"=="200" (
    ...
    echo Uploading updated model
    copy "newlyUpdatedModel.R" "liveModel10.R"
    curl -X POST -F "token=%TOKEN%" -F "script=@.\liveModel10.R" https://%URL%/api/reds-model/1/upload-daily-build
