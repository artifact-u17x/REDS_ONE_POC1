# call with Rscript sparrowModelBenVersion.R /app/models/data/input.csv /app/models/data/output.csv

start.time <- Sys.time()

# set the script path
# setwd("/app/models/scripts/sparrow_suitability") 
